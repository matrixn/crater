  ...
  return defineStoreFunc({
    ...
    state: () => ({
      ...
      frequencies: [
        ...
        { label: global.t('recurring_invoices.frequency.every_30_minutes'), value: '*/30 * * * *' },
        { label: global.t('recurring_invoices.frequency.every_hour'), value: '0 * * * *' },
        { label: global.t('recurring_invoices.frequency.every_2_hours'), value: '0 */2 * * *' },
        { label: global.t('recurring_invoices.frequency.twice_day'), value: '0 13-15 * * *' },
        { label: global.t('recurring_invoices.frequency.every_week'), value: '0 0 * * 0' },
        { label: global.t('recurring_invoices.frequency.every_15_days'), value: '0 5 */15 * *' },
        { label: global.t('recurring_invoices.frequency.first_day_month'), value: '0 0 1 * *' },
